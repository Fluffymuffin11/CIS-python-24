In the Pizza calculator Week 1 i learned how to use basic functions and syntax in python
...
in the functions homework i learned how to implement a function that would filter out unwanted data in a simple time output program
